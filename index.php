...
<div id="banner1" style="background-repeat:no-repeat;">
        <div class="box-left" >
            <a href="thucdon_2.php?id_sanpham=1"><button>Buy now </button><!--nút mua hàng --></a>
        </div>
 </div>
<!--------------------NEW ARRIVALS--------------------------- -->
   <section class="main">
...
<!--------------------BANNER SPRING OF THE Y--------------------------- -->
    <div id="banner2"><!--banner2 baneer rồng -->
        <div class="box-left" >
            ...
            <a href="thucdon_2.php?id_sanpham=2"><button>Buy now </button><!--nút mua hàng --></a>
        </div>
    </div>
...
<!--------------------BANNER LILIWYUN--------------------------- -->
    <div id="banner3"><!--banner3 banner liliwyun  -->
        <div class="box-left" >
            <a href="thucdon_2.php?id_sanpham=3"><button>Buy now </button><!--nút mua hàng --></a>
        </div>
    </div>
    ...
    <div id="new">
        ...
        <ul id="list-new">
            <div class="item"><!--sản phẩm 1 -->
                ...
                <div class="name">ĐẬM CHẤT ĐƯỜNG PHỐ</div>
            </div>
            <div class="box-left" >
